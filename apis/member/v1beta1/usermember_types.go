...
// UserMemberParameters define the desired state of a Harbor project user member.
type UserMemberParameters struct {
	// ProjectID is the project name or numeric ID the member belongs to.
	// +kubebuilder:validation:Required
	ProjectID string `json:"projectId"`

	// Username is the Harbor user to add as a project member.
	// +kubebuilder:validation:Required
...
// UserMemberObservation reflects the observed state of a Harbor project user member.
...
// A UserMember adds a Harbor user to a project with a role (member_user).
