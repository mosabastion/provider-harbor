...
// GroupMemberObservation reflects the observed state of a Harbor project group member.
...
// A GroupMember adds a Harbor user group to a project with a role (member_group).
